...
from .geometry import NozzleGeometry, load_geometry
...
def analyze_case(
    ...
    *,
    ...
    target_tolerance_fs: float = 25.0,
    ...
    mass_kg = float(probe.get("mass_kg", CARBON12_MASS_KG)) if isinstance(probe, dict) else CARBON12_MASS_KG
    carbon_rows = read_particle_extrema(reduced_path, mass_kg=mass_kg)
    carbon_metric = carbon_target_metric(
        carbon_rows,
        target_time_fs=target_time_fs,
        tolerance_fs=target_tolerance_fs,
    )
    ...
    summary: dict[str, Any] = {
        ...
        "objective_carbon_delta_kz_1ps_MeV": carbon_metric.delta_kz_MeV,
        "objective_exit_ez_p995_peak_100_300fs_V_m": float(
            field_objective["p995_abs_Ez_V_m"]
        ),
        "carbon_target_requested_fs": carbon_metric.target_time_fs,
        "carbon_target_actual_fs": carbon_metric.actual_time_fs,
        "carbon_target_time_error_fs": carbon_metric.target_time_error_fs,
        "carbon_initial_kz_MeV": carbon_metric.initial_kz_MeV,
        "carbon_target_kz_MeV": carbon_metric.target_kz_MeV,
        "carbon_target_total_kinetic_MeV": carbon_metric.target_total_kinetic_MeV,
        "carbon_target_pz_over_mc": carbon_metric.target_pz_over_mc,
        ...
        "exit_ez_peak_transverse_um": float(field_objective["peak_transverse_um"]),
    ...
    report = {
        "schema_version": 1,
        "summary": summary,
        "carbon_target": asdict(carbon_metric),
        "outputs": {
